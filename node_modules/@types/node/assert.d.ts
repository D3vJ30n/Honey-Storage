...
declare module "assert" {
    ...
    namespace assert {
         ...
         * // against the error message, study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js throws an `ERR_AMBIGUOUS_ARGUMENT` error.
