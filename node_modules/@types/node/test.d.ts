...
declare module "node:test" {
    ...
    class TestContext {
         ...
         * have the `only` option set. Otherwise, all tests are run. If study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js was not
    ...
    class MockTracker {
         ...
         * CommonJS modules, and study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js builtin modules. Any references to
    ...
    class MockTimers {
         ...
         *
         * **Note:** This diverges from how `setTimeout` in study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js behaves and accepts
         * only positive numbers. In study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js, `setTimeout` with negative numbers is
...
interface TestCoverage {
    ...
    summary: {
         ...
         * the tests changed the working directory of the study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js process.
         */
