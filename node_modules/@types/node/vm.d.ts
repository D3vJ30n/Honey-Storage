...
declare module "vm" {
    ...
    namespace constants {
         ...
         * and `vm.compileFunction()` so that study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js uses the default ESM loader from the main
