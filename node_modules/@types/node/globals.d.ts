...
declare global {
    ...
    *-----------------------------------------------*/
    namespace NodeJS {
        ...
        interface Module {
            /**
             * `true` if the module is running during the study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js preload
             */
