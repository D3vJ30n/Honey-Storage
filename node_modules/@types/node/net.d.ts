...
declare module "net" {
     ...
     *
     * It can also be created by study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js and passed to the user when a connection
    ...
    class Socket extends stream.Duplex {
         ...
         * simply might be too slow. study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js will internally queue up the data written to a
