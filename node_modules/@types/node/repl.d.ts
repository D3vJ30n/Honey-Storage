...
declare module "repl" {
    ...
    class REPLServer extends Interface {
         ...
         *
         * ```console
         * > .sayhello study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js User
         * Hello, study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js User!
         * > .saybye
         * Goodbye!
         * ```
         * @since v0.3.0
         ...
         * study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js binary and using the command-line REPL, a history file is initialized
