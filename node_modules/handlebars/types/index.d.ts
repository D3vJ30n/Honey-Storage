...
declare namespace Handlebars {
  ...
  export class Exception {
      constructor(message: string, node?: hbs.AST.study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node);
      description: string;
      fileName: string;
      lineNumber?: any;
      endLineNumber?: any;
  ...
  interface ICompiler {
      accept(node: hbs.AST.study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node): void;
  ...
  export class Visitor implements ICompiler {
      accept(node: hbs.AST.study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node): void;
      acceptKey(node: hbs.AST.study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node, name: string): void;
...
declare namespace hbs {
  namespace AST {
      ...
      interface Program extends study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node {
          body: Statement[];
          blockParams: string[];
      }
      ...
      interface Hash extends study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node {
          type: 'Hash';
          pairs: HashPair[];
      }

      interface HashPair extends study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node {
          type: 'HashPair';
          key: string;
          value: Expression;
      }
      ...
      interface helpers {
          helperExpression(node: study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node): boolean;
