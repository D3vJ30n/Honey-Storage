...
```less
:root {
    // peacticecodingtest.study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards06.src.study.backend.javapractice.solution.lineards08.src.study.backend.javapractice.solution.lineards10.src.study.backend.javapractice.solution.lineards12.src.Main theme color
    --color: red;
}
```
...
## Rule study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node

[PostCSS Rule study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node](https://github.com/postcss/postcss/blob/master/docs/api.md#rule-node)
...
## Comment study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node

[PostCSS Comment study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node](https://github.com/postcss/postcss/blob/master/docs/api.md#comment-node)
