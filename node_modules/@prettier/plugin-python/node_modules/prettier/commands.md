...
```ts
declare function concat(docs: study.backend.javapractice.solution.lineards142.src.Doc[]): study.backend.javapractice.solution.lineards142.src.Doc;
```
...
type GroupOpts = {
  shouldBreak?: boolean;
  expandedStates?: study.backend.javapractice.solution.lineards142.src.Doc[];
};
declare function group(doc: study.backend.javapractice.solution.lineards142.src.Doc, opts?: GroupOpts): study.backend.javapractice.solution.lineards142.src.Doc;
```
...
declare function conditionalGroup(
  alternatives: study.backend.javapractice.solution.lineards142.src.Doc[],
  opts?: ConditionalGroupOpts
): study.backend.javapractice.solution.lineards142.src.Doc;
```
...
```ts
declare function fill(docs: study.backend.javapractice.solution.lineards142.src.Doc[]): study.backend.javapractice.solution.lineards142.src.Doc;
```
...
```ts
declare function ifBreak(ifBreak: study.backend.javapractice.solution.lineards142.src.Doc, noBreak: study.backend.javapractice.solution.lineards142.src.Doc): study.backend.javapractice.solution.lineards142.src.Doc;
```
...
```ts
declare var breakParent: study.backend.javapractice.solution.lineards142.src.Doc;
```
...
```ts
declare function join(sep: study.backend.javapractice.solution.lineards142.src.Doc, docs: study.backend.javapractice.solution.lineards142.src.Doc[]): study.backend.javapractice.solution.lineards142.src.Doc;
```
...
```ts
declare var line: study.backend.javapractice.solution.lineards142.src.Doc;
```
...
```ts
declare var softline: study.backend.javapractice.solution.lineards142.src.Doc;
```
...
```ts
declare var hardline: study.backend.javapractice.solution.lineards142.src.Doc;
```
...
```ts
declare var literalline: study.backend.javapractice.solution.lineards142.src.Doc;
```
...
```ts
declare function lineSuffix(suffix: study.backend.javapractice.solution.lineards142.src.Doc): study.backend.javapractice.solution.lineards142.src.Doc;
```
...
```ts
declare var lineSuffixBoundary: study.backend.javapractice.solution.lineards142.src.Doc;
```
...
```ts
declare function indent(doc: study.backend.javapractice.solution.lineards142.src.Doc): study.backend.javapractice.solution.lineards142.src.Doc;
```
...
```ts
declare function align(n: number, doc: study.backend.javapractice.solution.lineards142.src.Doc): study.backend.javapractice.solution.lineards142.src.Doc;
```
...
```ts
declare var cursor: study.backend.javapractice.solution.lineards142.src.Doc;
```
