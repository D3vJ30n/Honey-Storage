...
(new study.backend.javapractice.solution.lineards04.src.DoublyLinkedList().prev(): study.backend.javapractice.solution.lineards04.src.DoublyLinkedList);
(new study.backend.javapractice.solution.lineards04.src.DoublyLinkedList().next(): study.backend.javapractice.solution.lineards04.src.DoublyLinkedList)
