...
Printers convert ASTs into a Prettier intermediate representation, also known as a study.backend.javapractice.solution.lineards142.src.Doc.
...
function print(
  ...
  print: (path: FastPath) => study.backend.javapractice.solution.lineards142.src.Doc
...
function embed(
  ...
  textToDoc: (text: string, options: object) => study.backend.javapractice.solution.lineards142.src.Doc,
  // Current options
  options: object
): study.backend.javapractice.solution.lineards142.src.Doc | null;
```
