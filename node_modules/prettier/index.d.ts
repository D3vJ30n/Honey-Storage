...
export type AST = any;
export type study.backend.javapractice.solution.lineards142.src.Doc = doc.builders.study.backend.javapractice.solution.lineards142.src.Doc;
...
export interface Printer<T = any> {
  print(
    ...
    print: (path: AstPath<T>) => study.backend.javapractice.solution.lineards142.src.Doc,
    args?: unknown,
  ...
  embed?:
    | ((
        ...
        | ((
            textToDoc: (text: string, options: Options) => Promise<study.backend.javapractice.solution.lineards142.src.Doc>,
            print: (
              selector?: string | number | Array<string | number> | AstPath,
            ) => study.backend.javapractice.solution.lineards142.src.Doc,
            path: AstPath,
            options: Options,
          ) => Promise<study.backend.javapractice.solution.lineards142.src.Doc | undefined> | study.backend.javapractice.solution.lineards142.src.Doc | undefined)
        | study.backend.javapractice.solution.lineards142.src.Doc
        | null)
    | undefined;
  preprocess?:
  ...
  printComment?:
    | ((commentPath: AstPath<T>, options: ParserOptions<T>) => study.backend.javapractice.solution.lineards142.src.Doc)
    | undefined;
  /**
