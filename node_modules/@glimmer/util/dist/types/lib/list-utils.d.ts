...
export declare class study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.LinkedList<T extends LinkedListNode> implements Slice<T> {
    private _head;
    private _tail;
    constructor();
    head(): Option<T>;
