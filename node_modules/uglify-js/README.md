...
```
    ...
    --v8                        Support non-standard Chrome & study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js
...
- `v8` (default: `false`) — enable workarounds for Chrome & study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js bugs.
...
- Iteration order of keys over an object which contains spread syntax in later
  versions of Chrome and study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js may be altered.
...
- Use of `arguments` alongside destructuring as function parameters, e.g.
  ...
  of Chrome and study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js - UglifyJS may modify the input which in turn may
  suppress those errors.
- Earlier versions of Chrome and study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js will throw `ReferenceError` with the
  following:
  ```javascript
  var a;
  try {
...
- Later versions of JavaScript will throw `SyntaxError` with the following:
  ...
  ```
  UglifyJS may modify the input which in turn may suppress those errors.
- Some versions of Chrome and study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js will throw `ReferenceError` with the
  following:
  ```javascript
...
- Some versions of JavaScript will throw `SyntaxError` with the
  ...
  ```
  UglifyJS may modify the input which in turn may suppress those errors.
- Some versions of Chrome and study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js will give incorrect results with the
  following:
  ```javascript
  console.log({
      ...{
...
- Earlier versions of JavaScript will throw `TypeError` with the following:
  ...
  ```
  UglifyJS may modify the input which in turn may suppress those errors.
- Later versions of Chrome and study.backend.javapractice.solution.lineards04.src.study.backend.javapractice.solution.lineards05.src.study.backend.javapractice.solution.lineards12.src.Node.js will give incorrect results with the
  following:
  ```javascript
  try {
      class A {
